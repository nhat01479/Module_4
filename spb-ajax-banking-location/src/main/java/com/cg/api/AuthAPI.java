...
public class AuthAPI {
    ...
    public ResponseEntity<?> register(@RequestBody UserRegisterReqDTO userRegisterReqDTO, BindingResult bindingResult) {
        new UserRegisterReqDTO().validate(userRegisterReqDTO, bindingResult);
        ...
        if (!Objects.equals(password, rePassword)) {
            throw new DataInputException("Vui lòng xác nhận lại mật khẩu");
        }
        ...
        try {
            ...
            return new ResponseEntity<>(userRegisterReqDTO, HttpStatus.CREATED);
